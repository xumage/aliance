!(function (t, e) {
    ...
    class f {
        ...
        _saveSelection() {
            this.displayValue !== this.el.value && console.warn("Element value was changed outside of mask. Syncronize mask using `mask.updateValue()` to work properly."), (this._selection = { start: this.selectionStart, end: this.cursorPos });
        }
        updateValue() {
        ...
        updateControl(t) {
            ...
            (this._unmaskedValue = e), (this._value = s), (this._rawInputValue = i), this.el.value !== a && (this.el.value = a), "auto" === t ? this.alignCursor() : null != t && (this.cursorPos = t), u && this._fireChangeEvents(), this._historyChanging || (!u && !this.history.isEmpty) || this.history.push({ unmaskedValue: e, selection: { start: this.selectionStart, end: this.cursorPos } });
        }
        updateOptions(t) {
            const { mask: e, ...s } = t,
                i = !this.maskEquals(e),
    ...
    class C {
        ...
        splice(t, e, s, i, n) {
            ...
            let p = t;
            const d = new v();
            if ((i !== a.NONE && ((p = this.nearestInputPos(t, e > 1 && 0 !== t && !o ? a.NONE : i)), (d.tailShift = p - t)), d.aggregate(this.remove(p)), o && i !== a.NONE && l === this.rawInputValue))
                if (i === a.FORCE_LEFT) {
                    let t;
                    for (; l === this.rawInputValue && (t = this.displayValue.length); ) d.aggregate(new v({ tailShift: -1 })).aggregate(this.remove(t - 1));
    ...
    class b extends C {
        ...
        _rebuildMask() {
            ...
            for (let a = 0; a < e.length; ++a) {
                if (this.blocks) {
                    ...
                    if (i) {
                        const { expose: t, repeat: e, ...s } = p(this.blocks[i]),
                            u = { lazy: this.lazy, eager: this.eager, placeholderChar: this.placeholderChar, displayChar: this.displayChar, overwrite: this.overwrite, autofix: this.autofix, ...s, repeat: e, parent: this },
                ...
                const r = n ? new S({ isOptional: i, lazy: this.lazy, eager: this.eager, placeholderChar: this.placeholderChar, displayChar: this.displayChar, ...p(t[u]), parent: this }) : new x({ char: u, eager: this.eager, isUnmasking: s });
                this._blocks.push(r);
            }
        }
        get state() {
    ...
    (b.DEFAULTS = { ...C.DEFAULTS, lazy: !0, placeholderChar: "_" }), (b.STOP_CHAR = "`"), (b.ESCAPE_CHAR = "\\"), (b.InputDefinition = S), (b.FixedDefinition = x), (o.MaskedPattern = b);
    class D extends b {
        get _matchFrom() {
    ...
    class y extends b {
        ...
        _update(t) {
            ...
            t.min && (n.Y.from = t.min.getFullYear()), t.max && (n.Y.to = t.max.getFullYear()), t.min && t.max && n.Y.from === n.Y.to && ((n.m.from = t.min.getMonth() + 1), (n.m.to = t.max.getMonth() + 1), n.m.from === n.m.to && ((n.d.from = t.min.getDate()), (n.d.to = t.max.getDate()))), Object.assign(n, this.blocks, a), super._update({ ...u, mask: e(s) ? s : i, blocks: n });
        }
        doValidate(t) {
            const e = this.date;
    ...
    (y.GET_DEFAULT_BLOCKS = () => ({ d: { mask: D, from: 1, to: 31, maxLength: 2 }, m: { mask: D, from: 1, to: 12, maxLength: 2 }, Y: { mask: D, from: 1900, to: 9999 } })),
        (y.DEFAULTS = {
            ...b.DEFAULTS,
            mask: Date,
            pattern: "d{.}`m{.}`Y",
    ...
    class M extends C {
        ...
        _applyDispatch(t, e, s) {
            ...
            return (this.currentMask = this.doDispatch(t, { ...e }, s)), this.currentMask && (this.currentMask !== r ? (this.currentMask.reset(), u && (this.currentMask.append(u, { raw: !0 }), (h.tailShift = this.currentMask.value.length - i.length)), n && (h.tailShift += this.currentMask.append(n, { raw: !0, tail: !0 }).tailShift)) : o && (this.currentMask.state = o)), h;
        }
        _appendPlaceholder() {
        ...
        dispatch: (t, e, s, i) => {
            ...
            const u = e.rawInputValue,
                n = e.compiledMasks.map((n, r) => {
                    ...
                    return n.rawInputValue !== u ? (n.reset(), n.append(u, { raw: !0 })) : h || n.remove(o), n.append(t, e.currentMaskFlags(s)), n.appendTail(i), { index: r, weight: n.rawInputValue.length, totalInputPositions: n.totalInputPositions(0, Math.max(o, n.nearestInputPos(n.displayValue.length, a.FORCE_LEFT))) };
                });
    ...
    class w extends C {
        ...
        _appendCharRaw(t, e) {
            ...
            r ? (n = new v({ inserted: this._value.slice(a.length), rawInserted: h ? "" : t, skip: h })) : ((this._value = a), (n = new v())), (this._value = this._insertThousandsSeparators(this._value));
    ...
    class L extends b {
        ...
        _update(t) {
            ...
            (this.repeat = null != (e = null != (s = null != a ? a : n.repeat) ? s : this.repeat) ? e : 1 / 0), super._update({ mask: "m".repeat(Math.max((this.repeatTo === 1 / 0 && (null == (i = this._blocks) ? void 0 : i.length)) || 0, this.repeatFrom)), blocks: { m: n }, eager: n.eager, overwrite: n.overwrite, skipInvalid: n.skipInvalid, lazy: n.lazy, placeholderChar: n.placeholderChar, displayChar: n.displayChar });
        }
        _allocateBlock(t) {
